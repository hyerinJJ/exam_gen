...
11. 에세이형(essay)이나 응용형(application)의 문제가 과도하게 길지는 않은가; 소문항이 4개 이상이거나 지시문이 5줄 이상이면 부적합
12. 진위형(tf): 단일 사실 하나만 담고 있는가; "A이고 B이다", "A지만 B이다", "A와 B는 모두~"처럼 두 사실을 동시에 판단해야 하는 복합 명제이면 부적합; 질문형·나열형도 부적합
