...
- Claude API (Anthropic) — topic_extractor, short/essay generator
...
├── tools/file_readers.py, search_tools.py, file_writers.py, claude_client.py
...
| short/essay generator | 기본형 | claude-sonnet-4-6 | 없음 |
